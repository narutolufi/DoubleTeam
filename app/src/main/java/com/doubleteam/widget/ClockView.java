...
public class ClockView extends View {
    ...
    public ClockView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ClockStyleable, defStyle, 0);
        //获取自定义属性
        ...
        ta.recycle();
        paint = new Paint();
        paint.setColor(context.getResources().getColor(R.color.TextPrimaryColor));
